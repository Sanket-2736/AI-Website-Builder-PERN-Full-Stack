  ...
  return (
    <div>
      <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
        <div className='text-center mt-3'>
          ...
          <p className="text-gray-400 text-sm max-w-md mx-auto mt-2">
            Select from our flexible pricing plans designed to suit your needs,
            whether you're just starting out or need advanced features for your
            projects.
          </p>
        </div>
      ...
      <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>
        ...
        consume <span className='text-white'>5 credits</span>. You can purchase additional credits at any time.
      </p>
      </div>
      <Footer/>
    </div>
